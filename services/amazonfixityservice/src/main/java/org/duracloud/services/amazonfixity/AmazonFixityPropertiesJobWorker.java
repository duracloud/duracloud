 ...
 * Date: Sept 21, 2010
 */
public class AmazonFixityPropertiesJobWorker extends BaseAmazonMapReduceJobWorker {

    public AmazonFixityPropertiesJobWorker(ContentStore contentStore,
                                           String workSpaceId,
    ...
    protected Map<String, String> getParamToResourceFileMap() {
        ...
        map.put(HadoopTypes.TASK_PARAMS.JAR_CONTENT_ID.name(),
                "fixity-properties-processor.hjar");
        return map;
    }
