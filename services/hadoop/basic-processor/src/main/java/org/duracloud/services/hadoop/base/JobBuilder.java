...
import static org.duracloud.services.hadoop.base.HadoopTypes.TASK_PARAMS;
...
public class JobBuilder {
    ...
    public JobConf getJobConf() throws IOException, ParseException {
        String inputPathPrefix = initParams.get(HadoopTypes.TASK_PARAMS.INPUT_PATH.getLongForm());
