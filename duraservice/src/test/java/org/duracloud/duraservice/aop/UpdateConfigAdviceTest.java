...
public class UpdateConfigAdviceTest {

    private UpdateConfigAdvice updateConfigAdvice;

    @Before
    public void setUp() throws Exception {
        updateConfigAdvice = new UpdateConfigAdvice();
    }

    @Test
    public void testNullParams() throws Throwable {
        try{
            updateConfigAdvice.afterReturning(null, null, null, null);
            assertTrue(false);
    ...
    public void testEmptyParam() throws Throwable {
        try{
            updateConfigAdvice.afterReturning(null, null, new Object[]{}, null);
            assertTrue(false);
