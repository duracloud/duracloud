...
public class SpaceDeleteAdvice
    ...
    private void publishDeleteEvent(SpaceMessage deleteEvent) {
        getSpaceJmsTemplate().convertAndSend(getDestination(), deleteEvent);
    }

    private SpaceMessage createDeleteMessage(Object[] methodArgs) {
    ...
    private void doLogging(Object returnObj,
        ...
        log.debug(pre0 + "advice: publish to space delete topic");
