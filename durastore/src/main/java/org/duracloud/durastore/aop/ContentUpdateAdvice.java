...
public class ContentUpdateAdvice
    ...
    private void publishUpdateEvent(ContentMessage updateEvent) {
        getContentJmsTemplate().convertAndSend(getDestination(), updateEvent);
    }

    private ContentMessage createUpdateMessage(Object[] methodArgs) {
    ...
    private void doLogging(Object returnObj,
        ...
        log.debug(pre0 + "advice: publish to content update topic");
