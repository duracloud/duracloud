...
public class ContentUpdateAdviceTest {

    private ContentUpdateAdvice contentUpdateAdvice;

    @Before
    public void setUp() throws Exception {
        contentUpdateAdvice = new ContentUpdateAdvice();
    }

    @Test
    public void testNullParams() throws Throwable {
        try{
            contentUpdateAdvice.afterReturning(null, null, null, null);
            assertTrue(false);
    ...
    public void testEmptyParam() throws Throwable {
        try{
            contentUpdateAdvice.afterReturning(null, null, new Object[]{}, null);
            assertTrue(false);
    ...
    public void testNullDestination() throws Throwable {
        ...
        contentUpdateAdvice.setJmsTemplate(jmsTemplate);
        contentUpdateAdvice.setDestination(destination);
        contentUpdateAdvice.setSecurityContextUtil(securityContextUtil);
        contentUpdateAdvice.afterReturning(null, null,
