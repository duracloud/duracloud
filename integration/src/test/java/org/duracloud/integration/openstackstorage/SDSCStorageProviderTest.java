...
public class SDSCStorageProviderTest extends OpenStackStorageProviderTest {
    ...
    public void setUp() {
        ...
        try {
            SimpleCredential cred = testConfigUtil.getCredential(StorageProviderCredential.ProviderType.SDSC);
            storageProvider = new SDSCStorageProvider(cred.getUsername(), cred.getPassword());
            super.setUp();
